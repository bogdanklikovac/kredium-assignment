    ...
    <div class="bg-white shadow-lg rounded-lg p-8 w-full max-w-2xl">
        ...
        <form action="{{ route('clients.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="number" id="cash_loan_amount" name="cash_loan_amount" class="w-full p-3 mt-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="number" id="home_loan_property_value" name="home_loan_property_value" class="w-full p-3 mt-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>

            <div class="mb-4">
                <label for="home_loan_down_payment" class="block text-lg font-semibold">Down Payment:</label>
                <input type="number" id="home_loan_down_payment" name="home_loan_down_payment" class="w-full p-3 mt-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
